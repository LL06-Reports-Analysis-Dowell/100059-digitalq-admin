...
class DeliveryscanWidget extends StatefulWidget {
  const DeliveryscanWidget({Key? key}) : super(key: key);

  @override
  _DeliveryscanWidgetState createState() => _DeliveryscanWidgetState();
}

class _DeliveryscanWidgetState extends State<DeliveryscanWidget> {
